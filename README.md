...
Analista de dados em formação com foco em transformar dados em decisões de negócio. Possuo experiência prática em projetos de análise de redes sociais, retenção, dados financeiros e comportamento de clientes, identificando oportunidades de crescimento, otimização de performance e melhoria de processos.
...
### 🔹 Studio Faria — Análise e Estratégia de Instagram
Projeto real de análise de dados do Instagram de uma barbearia, com diagnóstico completo de performance e dashboard interativo para monitoramento contínuo.

- Diagnóstico de queda progressiva: alcance médio caiu de 210 para 94 em 3 meses
- Identificação de queda de engajamento de 8% para 4% no período
- Análise por tipo de post, tema e etapa do funil de conteúdo
- Dashboard completo em Power BI com 5 páginas: visão geral, conteúdo, funil, horários e histórico de posts
...
- Diagnóstico de performance com base em dados reais
- Identificação de gargalos em funis de conversão e conteúdo
